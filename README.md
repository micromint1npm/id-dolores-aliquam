# @micromint1npm/id-dolores-aliquam&nbsp;&nbsp;&nbsp;[![Build Status](https://github.com/micromint1npm/id-dolores-aliquam/actions/workflows/ci.yml/badge.svg)](https://github.com/micromint1npm/id-dolores-aliquam/actions/workflows/ci.yml) [![Coverage Status](https://coveralls.io/repos/davedoesdev/@micromint1npm/id-dolores-aliquam/badge.png?branch=master)](https://coveralls.io/r/davedoesdev/@micromint1npm/id-dolores-aliquam?branch=master) [![NPM version](https://badge.fury.io/js/@micromint1npm/id-dolores-aliquam.png)](http://badge.fury.io/js/@micromint1npm/id-dolores-aliquam)
...
var Primus = require('primus'),
    PrimusDuplex = require('@micromint1npm/id-dolores-aliquam').PrimusDuplex,
...
```shell
npm install @micromint1npm/id-dolores-aliquam
```
...
[c8](https://github.com/bcoe/c8) results are available [here](http://rawgit.davedoesdev.com/davedoesdev/@micromint1npm/id-dolores-aliquam/master/coverage/lcov-report/index.html).

Coveralls page is [here](https://coveralls.io/r/davedoesdev/@micromint1npm/id-dolores-aliquam).
